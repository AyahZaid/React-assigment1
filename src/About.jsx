...
export default function About() {
  return (
    <div>
    <section className='About bg-green mt-5 pt-5 pb-5'>
    <div className='container justify-content-center align-items-center d-flex flex-column'>
    <h1 className=' fw-bold text-light heading-text pt-5'>ABOUT</h1>
    ...
    <p className='text-light fs-5'>Freelancer is a free bootstrap theme created by Route. The download includes the complete source files including HTML, CSS, and JavaScript as well as optional SASS stylesheets for easy customization.</p>
    </div>
